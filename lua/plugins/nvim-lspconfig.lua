  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- map('<leader>rs', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[W]orkspace [S]ymbols')
    ...
    local servers = {
      -- NOTE: Install/remove LSPs here. They will be automatically installed. To ensure the servers
      -- below were installed, use
      --  :Mason
      --
